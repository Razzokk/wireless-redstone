...
public final class ModItems {
	...
	public static void register(RegisterUtil<Item> util) {
		...
		registerBlockItem(util, ModBlocks.redstoneTransmitterAttachment);
		registerBlockItem(util, ModBlocks.redstoneReceiverAttachment);
		registerBlockItem(util, ModBlocks.p2pRedstoneTransmitterAttachment);
		registerBlockItem(util, ModBlocks.p2pRedstoneReceiverAttachment);
